	...
	<div id="tab-data">
		<div id="myTableAllotBatch">
			...
			<div id="myTableAllotBatch_operations">
				<p id="allotBatch_header">
					Allot Batch:
				</p>
				<p id="allotBatch_content">
					Lorem ipsum dolor sit amet, consectetur adipisicing elit. Saepe harum impedit voluptatibus quo expedita, cum, iusto laborum, adipisci aut maiores itaque fuga velit suscipit non beatae! Laborum, id facere qui.
				</p>
				<form action="" id="allotBatch_form" >
					<p >Enter Batch No:</p>
					<input type="text">
					<button>Allot Batch</button>
