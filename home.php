			...
			<div class="row">
				...
				<div class="col s12 m4 l4">
					<div class="center promo promo-example">
						...
						<p>
							CodeStrike is a CodeChef Campus Chapter of Atharva College of Engineering.This initiative was taken on 27th January 2014, to spread the coding string. </p>
						</div>
					</div>
					<div class="col s12 m4 l4">
						<div class="center promo promo-example">
		...
		<div class="section scrollspy" id="work">
			...
			<footer id="contact" class="page-footer default_color scrollspy">
				<div class="footer-copyright default_color">
					<div class="container">
						<b> <p>&copy; 2016 codestrike.in<p></b>
					</div>
				</div>
				<div class="container">  
					<div class="row">
							...
							<form class="col s12" action="contact.php" method="post">
								...
								<h5 class="white-text">Contact Us:</h5>
									<div class="input-field col s6">
										...
										<label for="icon_prefix" class="white-text">CodeStrike</label>
									</div>
									<br><br>
									<div class="input-field col s6">
										<i class="mdi-communication-email prefix white-text"></i>
										
										<label for="icon_email" class="white-text">codestrikehq@gmail.com</label>
									</div>
