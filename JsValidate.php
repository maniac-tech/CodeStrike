...
function insertData($func_var_name,$func_var_year,$func_var_branch,$func_var_emailID,$func_var_mobileNo){
	...
	$query="INSERT INTO $tableNameJs (Name,Year,Branch,Email,Mobile) VALUES ('$func_var_name','$func_var_year','$func_var_branch','$func_var_emailID','$func_var_mobileNo')";
...
function error($func_var_mobileNo){
	...
	$sql = "SELECT Name FROM $tableNameJS WHERE Mobile='$func_var_mobileNo'";
